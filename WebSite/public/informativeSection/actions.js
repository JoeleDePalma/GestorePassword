...
export class InformativeSectionActions {
    ...
    static ChangeMainContent(contentToShow) {
        const titleHeader = document.getElementById("contentTitle");
        const textParagraph = document.getElementById("contentText");
...
InformativeSectionActions.contentList = {
    info: {
